...
from locators.admin.categories_locators import CategoriesLocators
...
class CategoriesPage(BasePage):        
    def dashboard_categories(self):
        self.click(CategoriesLocators.CATEGORIES_BUTTON)
        time.sleep(12)
        
    def new_categories(self):
        ...
        time.sleep(4)
        self.wait.until(EC.presence_of_element_located(GeneralLocators.ICON_INPUT)).send_keys("D:/test/rumah.png")
        time.sleep(4)
