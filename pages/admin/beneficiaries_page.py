...
from locators.admin.beneficiaries_locators import BeneficiariesLocators
...
class BeneficiariesPage(BasePage):        
    def dashboard_beneficiaries(self):
        self.click(BeneficiariesLocators.BENEFICIARIES_BUTTON)
        time.sleep(12)
